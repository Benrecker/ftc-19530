...
@Config
@Disabled
@Autonomous(name = "hybridred")
public class ROCHawkKiller extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence drivesubhigh = drive.trajectorySequenceBuilder(new Pose2d(9.00, -63.00, Math.toRadians(0.00)))
                .lineToLinearHeading(new Pose2d(14.00, -34.00, Math.toRadians(350.00)))
                .build(); //raise to to 1900

        //drop 150

        TrajectorySequence pickupB1 = drive.trajectorySequenceBuilder(drivesubhigh.end())
                .lineToLinearHeading(new Pose2d(22.00, -40.00, Math.toRadians(0.00)))
                .lineToLinearHeading(new Pose2d(31.50, -44.00, Math.toRadians(45.00)))
                .build();//drop 0
        ...
        TrajectorySequence pickupB2 = drive.trajectorySequenceBuilder(dropoffB1.end())
                .lineToLinearHeading(new Pose2d(41.50, -44.00, Math.toRadians(45.00)))
                .build();
        //grab block
        ...
        TrajectorySequence pickupB3 = drive.trajectorySequenceBuilder(dropoffB2.end())
                .lineToLinearHeading(new Pose2d(51.50, -44.00, Math.toRadians(35.00)))
                .build();

        //grab block

        TrajectorySequence dropoffB3B3 = drive.trajectorySequenceBuilder(pickupB3.end())
                .lineToLinearHeading(new Pose2d(51.50, -44.00, Math.toRadians(35.00)))
                .build();

        //drop block

        TrajectorySequence pickupspec1 = drive.trajectorySequenceBuilder(dropoffB3B3.end())
                .lineToLinearHeading(new Pose2d(35.00, -53.00, Math.toRadians(270.00)))
                .lineToLinearHeading(new Pose2d(35.00, -64.00, Math.toRadians(270.00)))
                .build();

        //clamp on

        TrajectorySequence dropspec1 = drive.trajectorySequenceBuilder(pickupspec1.end())
                ...
                .lineToLinearHeading(new Pose2d(-4.00, -31.50, Math.toRadians(90.00)))
                .build();//delay raise to 1900
        ...
        TrajectorySequence pickupspec2 = drive.trajectorySequenceBuilder(dropspec1.end())
                ...
                .lineToLinearHeading(new Pose2d(35.00, -59.00, Math.toRadians(270.00)))
                .lineToLinearHeading(new Pose2d(35.00, -64.00, Math.toRadians(270.00)))
                .build();//delay drop to 0

        //clamp on

        TrajectorySequence dropspec2 = drive.trajectorySequenceBuilder(pickupspec2.end())
                .lineToLinearHeading(new Pose2d(35.00, -59.00, Math.toRadians(270.00)))
                .lineToLinearHeading(new Pose2d(-1.00, -36.50, Math.toRadians(90.00)))
                .lineToLinearHeading(new Pose2d(-1.00, -31.50, Math.toRadians(90.00)))
                .build();//delay raise to 1900
        ...
        TrajectorySequence dropspec3 = drive.trajectorySequenceBuilder(pickupspec3.end())
                .lineToLinearHeading(new Pose2d(35.00, -59.00, Math.toRadians(270.00)))
                .lineToLinearHeading(new Pose2d(2.00, -36.50, Math.toRadians(90.00)))
                .lineToLinearHeading(new Pose2d(2.00, -31.50, Math.toRadians(90.00)))
                .build();//delay raise to 1900
        ...
        TrajectorySequence park = drive.trajectorySequenceBuilder(dropspec4.end())
                .lineToLinearHeading(new Pose2d(35.00, -64.00, Math.toRadians(90.00)))
                .build();
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (state == 0) {
                ...
                if (timer.done()) {
                    ...
                    drive.followTrajectorySequenceAsync(dropoffB1);
                    state++;
                }
                //disgarging block
                ...
                if (timer.done()) {
                    grabber.intakeInSlow();
                    drive.followTrajectorySequenceAsync(dropoffB2);
                    state++;
                ...
                if (timer.done()) {
                    grabber.intakeInSlow();
                    drive.followTrajectorySequenceAsync(dropoffB3B3);
                    state++;
                }
            } else if (state == 13) {
                if (!drive.isBusy()) {
                ...
                if (elevator.atTarget()) {
                    drive.followTrajectorySequenceAsync(pickupspec3);
                    elevator.setHeight(0);
                    grabber.clamp_off();
                    state++;
                }
