...
public class fourboxbutterRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence trajectory0 = drive.trajectorySequenceBuilder(new Pose2d(-39.5, -63, Math.toRadians(90.00)))
        ...
        TrajectorySequence trajpickupB1 = drive.trajectorySequenceBuilder(trajectory0.end())
                ...
                .lineToLinearHeading(new Pose2d(-53.26, -51.64, Math.toRadians(83)))//this is the angle that may need to be changed
                .build();
        ...
        TrajectorySequence trajpickupB2 = drive.trajectorySequenceBuilder(trajectory0.end())
                .setConstraints(SampleMecanumDrive.getVelocityConstraint(35, 25, TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(15))
                .lineToLinearHeading(new Pose2d(-59.46, -50.90, Math.toRadians(90)))//this is the angle that may need to be changed
                .build();
        ...
        TrajectorySequence trajpickupB3 = drive.trajectorySequenceBuilder(trajectory0.end())
                .setConstraints(SampleMecanumDrive.getVelocityConstraint(35, 25, TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(15))
                .lineToLinearHeading(new Pose2d(-57.69, -50.75, Math.toRadians(117.0)))//this is the angle that may need to be changed
                .build();

        TrajectorySequence trajbeforeforwardb3 = drive.trajectorySequenceBuilder(trajpickupB3.end())
                .setConstraints(SampleMecanumDrive.getVelocityConstraint(35, 25, TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(15))
                .lineToLinearHeading(new Pose2d(-54.74, -55.18, Math.toRadians(45)))
                .build();
